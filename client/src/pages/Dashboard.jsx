    ...
    <div className='min-h-screen'>
        <div className='shadow py-4 '>
            <div className='px-5 flex justify-between items-center'>
                <img onClick={()=>navigate('/')} className='max-sm:w-32 cursor-pointer' src={assets.jobhive} alt="" />
                <div className='flex items-center gap-3'>
                    <p className='max-sm:hidden'>Welcome, Pritiranjan</p>
                    <div className='relative group'>
                        <img className='w-8 border-0 rounded-full' src={assets.company_icon} alt="" />
